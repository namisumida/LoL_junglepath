...
var dataset, posList, dataset_positions, array_priorXY, currMinute, heatmap_config, heatmapInstance, dataset_heatmap;
...
d3.csv('Data/old/compData.csv', rowConverterInput, function(data) {
