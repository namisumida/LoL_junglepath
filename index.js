function init() {
  ...
  function setup() {
    ...
    heatmapInstance = h337.create({
      ...
      gradient: {
        '0': d3.rgb(128,0,93),
        '0.08': d3.rgb(223,0,163),
        '0.17': d3.rgb(255,0,116),
        '0.25': d3.rgb(255,0,39),
        '0.32': d3.rgb(255,43,0),
        '0.4': d3.rgb(125,255,160),
        '0.48': d3.rgb(54,255,107),
        '0.64': d3.rgb(0,255,110),
        '0.72': d3.rgb(0,255,193)),
        '0.8': d3.rgb(0,227,255),
        '0.88': d3.rgb(0,163,223),
        '1': d3.rgb(0,93,128)
      }
    });
